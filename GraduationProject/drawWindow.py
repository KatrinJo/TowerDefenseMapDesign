...
class GraphicDisplay(tk.Tk):
    def __init__(self, agent):
        ...
        self.agent = agent
        self.is_moving = 0
        self.tower, self.enemy = self.load_images()
        # (self.up, self.down, self.left, self.right), self.shapes =
        self.canvas = self._build_canvas()
        self.scrollbar = self._build_scrollbar()
    ...
    def load_images(self):
        t1 = PhotoImage(Image.open("../img/tower1.png").resize((65, 65)))
        t2 = PhotoImage(Image.open("../img/tower2.png").resize((65, 65)))
        t3 = PhotoImage(Image.open("../img/tower3.png").resize((65, 65)))
        t4 = PhotoImage(Image.open("../img/tower4.png").resize((65, 65)))
        t5 = PhotoImage(Image.open("../img/tower5.png").resize((65, 65)))

        e1 = PhotoImage(Image.open("../img/enemy1.png").resize((13, 13)))
        e2 = PhotoImage(Image.open("../img/enemy2.png").resize((13, 13)))
        e3 = PhotoImage(Image.open("../img/enemy3.png").resize((13, 13)))
        return (t1, t2, t3, t4, t5), (e1, e2, e3)
